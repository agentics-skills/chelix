...
| Key                        | Type             | Default            | Description                                                                                                                                                                                                                                                                                                                                |
| -------------------------- | ---------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| workspace_root             | optional string  | —                  | Default search root used by `Glob` when the LLM call omits the `path` argument. Must be an absolute path. When unset, calls without an explicit `path` are rejected.                                                                                                                                                                       |
...
| respect_gitignore          | bool             | `true`             | Whether `Glob` respects `.gitignore` / `.ignore` files and `.git/info/exclude` while walking.                                                                                                                                                                                                                                               |
