...
- **[Generative UI with A2UI](a2ui.md)** — Interactive chat surfaces, action
  routing, validation, persistence, and troubleshooting
...
- **[A2UI](a2ui.md)** — Standards-based generative UI architecture
