...
pub(super) async fn complete_startup(
...

    {
        ...
        tool_registry.register(Box::new(crate::a2ui::RenderA2uiTool::new(Arc::clone(
            &state.a2ui_broker,
        ))));
        ...
        tool_registry.register(Box::new(
            chelix_tools::overwrite_file::OverwriteFileTool::new(Arc::clone(&tools_service)),
        ));
        tool_registry.register(Box::new(chelix_tools::read_file::ReadFileTool::new(
            Arc::clone(&tools_service),
        )));
        tool_registry.register(Box::new(chelix_tools::read_media::ReadMediaTool::new(
            Arc::clone(&tools_service),
        )));
