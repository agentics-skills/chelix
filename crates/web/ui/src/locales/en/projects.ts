...
export default {
	...
	clearAllTooltip: "Remove all repository entries from Chelix without deleting files on disk",
	pathInput: {
		directory: "Directory",
