...
test.describe("Authentication", () => {
	...
	test("setup page is accessible", async ({ page }) => {
		...
		if (/^\/chats\//.test(pathname)) {
			...
			await expect(
				page.getByRole("heading", {
					name: /^(Secure your instance|Set up your identity|Import from OpenClaw|Import Your Data|Add LLMs|Add providers|Voice \(optional\)|Connect a Channel|Setup Summary)$/,
				}),
			).toBeVisible();
		}
