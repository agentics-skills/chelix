...
use {
    ...
    chelix_protocol::{
        RipgrepRequest, RipgrepResponse, TOOLS_SERVICE_HEALTH_PATH, TOOLS_SERVICE_PROTOCOL_VERSION,
        TOOLS_SERVICE_RIPGREP_PATH, ToolsServiceError, ToolsServiceHealth,
    },
};
